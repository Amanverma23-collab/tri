...
import { ArrowUpRight, Check, Clock, Building2, FileCheck2, ArrowRight, Landmark, ShieldCheck } from 'lucide-react';

interface InsuranceServicesSectionProps {
  onOpenConsultation: (service?: string) => void;
}

export const InsuranceServicesSection: React.FC<InsuranceServicesSectionProps> = ({ onOpenConsultation }) => {
  const insuranceVertical = serviceVerticals.find((v) => v.id === 'insurance-loans') || serviceVerticals[2];
  const [selectedServiceId, setSelectedServiceId] = useState<string>(insuranceVertical.services[0].id);

  const selectedService: ServiceItem =
    insuranceVertical.services.find((s) => s.id === selectedServiceId) || insuranceVertical.services[0];

  return (
    <section id="insurance-details" className="py-28 bg-white border-b border-[#e5e4de] relative">
      <div className="o-container">
        ...
        <div className="max-w-2xl mb-16">
          <div className="text-[11px] font-mono font-bold tracking-widest text-[#047857] uppercase mb-3 flex items-center gap-2">
            ...
            <span>PRACTICE SPECIFICATIONS // 02 INSURANCE & CAPITAL</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-2.5">
            <div className="p-5 rounded-2xl bg-[#fafaf7] border border-[#e5e4de] mb-3 shadow-xs">
              ...
              <p className="text-[14px] text-[#334155] leading-relaxed font-medium">
                {insuranceVertical.whyItMatters}
              </p>
              <div className="mt-4 pt-3 border-t border-[#e5e4de] flex items-center justify-between">
                <span className="text-[12px] font-mono font-bold text-[#047857] uppercase">
                  {insuranceVertical.highlightMetric.value}
                </span>
                <span className="text-[11px] text-[#64748b]">
                  {insuranceVertical.highlightMetric.label}
                </span>
              </div>
            </div>
            ...
            {insuranceVertical.services.map((service, idx) => {
                ...
                <button
                  ...
                  className={`text-left p-4 rounded-xl border transition-all flex items-center justify-between cursor-pointer group ${
                    isSelected
                      ...
                      : 'border-[#e5e4de] bg-[#fafaf7] text-[#334155] hover:border-[#d1cfc7] hover:bg-white'
                  }`}
                >
                  <div className="pr-3">
              ...
              <div className="bezel-core p-6 sm:p-8">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 mb-6 pb-5 border-b border-[#f1f0ea]">
                  <div>
                    <span className="text-[10px] font-mono font-bold tracking-widest text-[#047857] uppercase block mb-1">
                      ACTIVE CREDIT & INSURANCE DOSSIER
                    </span>
                ...
                <div className="mb-6">
                  <div className="text-[11px] font-mono font-bold tracking-widest text-[#64748b] uppercase mb-3">
                    FACILITY SCOPE & UNDERWRITING PARAMETERS
                  </div>
                ...
                <div className="mb-8 pt-5 border-t border-[#f1f0ea]">
                  <div className="text-[11px] font-mono font-bold tracking-widest text-[#64748b] uppercase mb-3 flex items-center gap-1.5">
                    ...
                    <span>SANCTIONS & OFFICIAL CERTIFICATIONS</span>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-6 border-t border-[#f1f0ea]">
                  <div className="text-[12px] text-[#64748b]">
                    Direct connection to our <span className="font-semibold text-[#0a1118]">Multi-Bank Lending & Underwriting</span> desk.
                  </div>

                  <button
                    onClick={() => onOpenConsultation(`Insurance & Loans — ${selectedService.name}`)}
