...
export const Footer: React.FC<FooterProps> = ({ onOpenConsultation }) => {
  return (
    <footer className="relative bg-[#131713] text-[#F5F0E6] overflow-hidden select-none border-t border-[#7C8B6F]/20">
      ...
      {/* 1. Top Callout Strip (Desktop View Only) */}
      ...
      <div className="editorial-container pt-12 sm:pt-20 pb-12">
        ...
        {/* =========================================================================
            MOBILE LAYOUT (< md): Practice & Regulatory in 1 Row (2 cols)
            ========================================================================= */}
        <div className="md:hidden space-y-8 pb-10 border-b border-white/10">
          {/* Mobile Col 1: Brand Wordmark & Mission */}
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 font-mono text-[10px] text-[#7C8B6F]">
              <ShieldCheck className="w-3.5 h-3.5 text-[#C9AF6B]" />
              <span>Pan-India Compliance Governance</span>
            </div>
          </div>

          {/* Mobile Col 2: Practice Verticals & Regulatory Matrix Side-by-Side in 1 Row */}
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 font-sans text-xs">
                <li>
                  <Link
                    to="/services/hr"
                    className="text-white/70 hover:text-white inline-flex items-center gap-1.5 transition-all text-xs"
                  >
          ...
          {/* Mobile Col 3: Direct Engagement Desk */}
          <div className="space-y-3 pt-2">
            ...
            <div className="grid grid-cols-1 gap-2.5">
              <a
                ...
                className="p-3.5 rounded-xl bg-white/5 border border-white/10 hover:border-[#7C8B6F] transition-colors block group"
              >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="font-mono text-xs font-bold text-white group-hover:text-[#C9AF6B] transition-colors truncate block max-w-[200px]">
        ...
        {/* =========================================================================
            DESKTOP LAYOUT (>= md): Full Original 4-Column Luxury Editorial Matrix
            ========================================================================= */}
        <div className="hidden md:grid grid-cols-12 gap-8 lg:gap-12 pb-16 border-b border-white/10">
          
          {/* Desktop Col 1: Brand Wordmark & Mission (4 cols) */}
          <div className="md:col-span-12 lg:col-span-4 space-y-6">
            ...
            <p className="font-sans text-sm text-white/70 leading-relaxed font-light max-w-sm">
              Business Solutions, Simplified. End-to-end statutory licensing, workforce architecture, liability protection, and digital growth acceleration under a single partner desk.
            </p>
          ...
          {/* Desktop Col 2: Practice Verticals (3 cols) */}
          ...
          {/* Desktop Col 3: Statutory Licensing (2 cols) */}
          ...
          {/* Desktop Col 4: Direct Engagement Desk (3 cols) */}
          <div className="md:col-span-12 lg:col-span-3 space-y-4">
            ...
            <div className="space-y-3 font-mono text-xs">
              <a
                href="tel:+918585999922"
                className="p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-[#7C8B6F] transition-colors block group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-white/50 text-[10px] block">DIRECT HELPLINE</span>
                    <span className="text-white font-bold group-hover:text-[#C9AF6B] transition-colors">
                      +91 8585999922
                    </span>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-white/50 text-[10px] block">EXECUTIVE EMAIL</span>
                    <span className="text-white font-bold group-hover:text-[#C9AF6B] transition-colors truncate block max-w-[170px]">
                      anuragsharma0120@gmail.com
                    </span>
                  </div>
                </div>
            ...
            <div className="flex items-center gap-2 text-white/60 font-mono text-xs pt-1">
              <MapPin className="w-3.5 h-3.5 text-[#7C8B6F] shrink-0" />
              <span>Delhi NCR, India • Pan-India Coverage</span>
            </div>
          </div>
