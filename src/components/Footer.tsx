      ...
      <div className="hidden md:block border-b border-white/10 bg-[#161B16]/80 py-10 sm:py-12">
        <div className="editorial-container flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className="btn-editorial-light text-xs shrink-0 cursor-pointer"
            data-cursor="Consult"
          >
      ...
      <div className="md:hidden editorial-container pt-10 pb-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 pt-2 border-t border-white/10">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-2 font-mono text-[11px] text-white/60">
              <li onClick={() => onOpenConsultation('FSSAI License')} className="cursor-pointer hover:text-white">
                • FSSAI State/Central
              </li>
              <li onClick={() => onOpenConsultation('Shop Act')} className="cursor-pointer hover:text-white">
                • Shop & Establishment
              </li>
              <li onClick={() => onOpenConsultation('DPCC Clearances')} className="cursor-pointer hover:text-white">
                • DPCC Clearances
              </li>
              <li onClick={() => onOpenConsultation('MCD Health Trade')} className="cursor-pointer hover:text-white">
                • MCD Health Trade
              </li>
              <li onClick={() => onOpenConsultation('Fire NOC')} className="cursor-pointer hover:text-white">
                • Fire Safety NOC
              </li>
              <li onClick={() => onOpenConsultation('PF ESIC Setup')} className="cursor-pointer hover:text-white">
                • PF / ESIC Setup
              </li>
            </ul>
          </div>
        ...
        <div className="pt-2 flex flex-col items-center gap-3 font-mono text-[10px] text-white/40 text-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/pricing" className="hover:text-white">Fee Matrix</Link>
          </div>
        </div>
      </div>

      {/* =========================================================================
          DESKTOP-ONLY VIEW (>= md): Full Original 4-Column Luxury Directory Matrix
          ========================================================================= */}
      <div className="hidden md:block editorial-container pt-16 sm:pt-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 pb-16 border-b border-white/10">
          ...
          <div className="md:col-span-12 lg:col-span-4 space-y-6">
            <Link to="/" className="inline-flex items-center gap-3.5 group" data-cursor="Home">
          ...
          {/* Col 4: Direct Engagement Desk (3 cols) */}
          <div className="md:col-span-12 lg:col-span-3 space-y-4">
            ...
            <a
              ...
              className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 hover:border-[#7C8B6F] hover:bg-white/[0.08] transition-all group"
            >
        ...
        {/* Large Typographic Masthead Banner with Exact Logo Blue Color & Clean Hover State */}
